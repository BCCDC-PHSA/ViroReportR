...
p_test_oneweek <- plotValidation(weekly_time_period_result, pred_horizon_str = "1 week ahead")

p_test_twoweek <- plotValidation(weekly_time_period_result, pred_horizon_str = "2 week ahead")
