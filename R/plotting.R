...
#' @examples
#' \dontrun{
#' # Assuming forecast_results is the output generated by `generate_forecast()``, i.e. forecast for one disease.
...
#' @examples 
#' \dontrun{
#' # Assuming data is the input data with `date`, `confirm`, `disease_type`, and `validation_results` is generated by `generate_validation()` using `data`.
#' plot_validation(data, validation_results)
#' }
#' @importFrom rlang .data
#' 
#' @export
