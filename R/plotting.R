...
#'
#' @param ... Named EpiEstim output objects produced by [forecast_epiestim()].
...
#' }
#'
#' @seealso [forecast_epiestim()], [EpiEstim::estimate_R()]
#' @keywords internal
#' @export
...
#'
#' @param ... Named forecast result objects produced by [forecast_epiestim()].
...
#' @examples
#' \dontrun{
#' # Assuming `forecast1` and `forecast2` are valid forecast_epiestim() outputs:
#' plot_forecast_comparison(ModelA = forecast1, ModelB = forecast2)
#' }
#'
#' @seealso [forecast_epiestim()], [ggplot2::ggplot()]
#' @keywords internal
#' @export
...
#'   produced by [`validate_forecast()`]. Each element should include:
