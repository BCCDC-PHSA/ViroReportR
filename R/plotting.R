...
#' @examples
#' \dontrun{
#' # Assuming forecast_results is the output generated by 
#' #`generate_forecast()``, i.e. forecast for one disease.
...
#' @examples 
#' \dontrun{
#' # Assuming input data has 3 columns `date`, `confirm`, `disease_type`,
#' # and `validation_results` is generated by `generate_validation()` using `data`.
