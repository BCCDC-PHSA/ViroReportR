...
plover_disease_types <- c("flu_a", "sars_cov2", "rsv")

phrdw_disease_types <- c("flu_a", "rsv")
...
```{r results = "asis"}
for(vri in plover_disease_types){
    cat(glue::glue("### {vri} \{.tabset\}")
    plot(plover_forecasts$forecasts$vri)
    cat("\n\n\n")
    current_forecast_text(plover_forecasts$forecasts$vri)
    cat("\n\n\n")
}
```
...
```{r results = "asis"}
for(vri in phrdw_disease_types){
    cat(glue::glue("### {vri} \{.tabset\}")
    plot(phrdw_forecasts$forecasts$vri)
    cat("\n\n\n")
    current_forecast_text(phrdw_forecasts$forecasts$vri)
    cat("\n\n\n")
}
```
...
for(vri in plover_disease_types){
    cat(glue::glue("### {vri} \{.tabset\}")
    plot_validation(plover_forecasts$forecasts$vri, pred_horizon_str = "1 week ahead", pred_plot = "ribbon")
}
```
...
for(vri in phrdw_disease_types){
    cat(glue::glue("### {vri} \{.tabset\}")
    plot_validation(phrdw_forecasts$forecasts$vri, pred_horizon_str = "1 week ahead", pred_plot = "ribbon")
}
```
...
for(vri in plover_disease_types){
    cat(glue::glue("### {vri} \{.tabset\}")
    summary_ind_quantiles_formatter(plover_forecasts$forecasts$vri)
    cat("\n\n\n")
    validation_summary_text(plover_forecasts$forecasts$vri)
    cat("\n\n\n")
}
```
...
for(vri in phrdw_disease_types){
    cat(glue::glue("### {vri} \{.tabset\}")
    summary_ind_quantiles_formatter(phrdw_forecasts$forecasts$vri)
    cat("\n\n\n")
    validation_summary_text(phrdw_forecasts$forecasts$vri)
    cat("\n\n\n")
}
```
