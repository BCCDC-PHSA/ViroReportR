...
for (vri in vri_name_list) {
  ...
  cat(glue::glue("#### {vri}"))
  cat("\n\n\n")
  print(plot_validation(validation_results$validation[[vri]], pred_plot = "ribbon"))
}
```
...
for (vri in vri_name_list) {
  cat(glue::glue("#### {vri}"))
  cat("\n\n\n")
  table_html <- forecast_validation_metric(
  ...
  # print(htmltools::tagList(ViroReportR:::forecast_validation_metric(validation_res = validation_results$validation[[vri]])))
  # print(datatable(ViroReportR:::forecast_validation_metric(validation_res = validation_results$validation[[vri]])))
  # cat("\n\n\n")
}
```
