...
vri_data <- vriforecasting:::get_all_vri_data(
  raw_plover_data = readRDS(config$PLOVER$temp_path),
  raw_phrdw_data = phrdw_flu_daily_count
)

# Reliable common estimation date
cred <- suppressWarnings(vriforecasting:::common_reliable_estimation_date(vri_data$plover_list, vri_data$phrdw_list))

# VRI names dictionary
disease_dict <- c(config$vri_names)
names(disease_dict) <- names(vri_data$plover_list)
```
...
plover_disease_types <- names(vri_data$plover_list)

phrdw_disease_types <- names(vri_data$phrdw_list)
...
#phrdw_forecasts[["forecasts"]] <- phrdw_forecasts$forecasts[ - which(names(phrdw_forecasts$forecasts) == "flu_b")]
```
...
for (vri in disease_dict) {
 ...
 print(plot(plover_forecasts$forecasts[[vri]]))
  cat("\n\n\n")
 print(vriforecasting:::plot_rt(phrdw_forecasts$forecasts[[vri]]))
  cat("\n\n\n")
...
```{r PHRDW forecast plots and info, results = "asis", out.width = '80%'}
for (vri in disease_dict) {
  cat(glue::glue("### {vri} {{.tabset}}"))
  cat("\n\n\n")
...
```{r PHRDW forecast validation plots, results = "asis", out.width = '90%'}
for (vri in disease_dict) {
  cat("\n\n\n")
  cat(glue::glue("### {vri} {{.tabset}}"))
  cat("\n\n\n")
  print(plot_validation(phrdw_forecasts$forecasts[[vri]], data = phrdw_forecasts$phrdw_list[[vri]], pred_horizon_str = "1 week ahead", pred_plot = "violin"))
}
```
...
htmltools::tagList(datatable(vriforecasting:::summary_ind_quantiles_formatter(time_period_result = plover_forecasts$forecasts$`Influenza-A`, data = plover_forecasts$plover_list$`Influenza-A`)))
```
...
for (vri in disease_dict) {
  ...
  cat(glue::glue("### {vri} {{.tabset}}"))
  cat("\n\n\n")
  print(htmltools::tagList(datatable(vriforecasting:::summary_ind_quantiles_formatter(time_period_result = plover_forecasts$forecasts[[vri]], data = plover_forecasts$plover_list[[vri]]))))
  cat("\n\n\n")
  vriforecasting:::validation_summary_text(time_period_result = plover_forecasts$forecasts[[vri]], data = plover_forecasts$plover_list[[vri]])
  cat("\n\n\n")
   vriforecasting:::validation_summary_text_season(time_period_result = plover_forecasts$forecasts[[vri]], data = plover_forecasts$plover_list[[vri]], year = 2021)
  cat("\n\n\n")
    vriforecasting:::validation_summary_text_season(time_period_result = plover_forecasts$forecasts[[vri]], data = plover_forecasts$plover_list[[vri]], year = 2022)
  cat("\n\n\n")
   vriforecasting:::validation_summary_text_season(time_period_result = plover_forecasts$forecasts[[vri]], data = plover_forecasts$plover_list[[vri]], year = 2023)
}
```

## PHRDW (pediatric population only) {.tabset .tabset-fade}

```{r PHRDW forecast validation metrics, results = "asis"}
for (vri in disease_dict) {
  cat("\n\n\n")
  cat(glue::glue("### {vri} {{.tabset}}"))
  cat("\n\n\n")
print(htmltools::tagList(datatable(vriforecasting:::summary_ind_quantiles_formatter(phrdw_forecasts$forecasts[[vri]], data = phrdw_forecasts$phrdw_list[[vri]]))))
  cat("\n\n\n")
  vriforecasting:::validation_summary_text(phrdw_forecasts$forecasts[[vri]], data = phrdw_forecasts$phrdw_list[[vri]])
  cat("\n\n\n")
   vriforecasting:::validation_summary_text_season(time_period_result = phrdw_forecasts$forecasts[[vri]], data = phrdw_forecasts$phrdw_list[[vri]], year = 2021)
  cat("\n\n\n")
    vriforecasting:::validation_summary_text_season(time_period_result = phrdw_forecasts$forecasts[[vri]], data = phrdw_forecasts$phrdw_list[[vri]], year = 2022)
  cat("\n\n\n")
   vriforecasting:::validation_summary_text_season(time_period_result = phrdw_forecasts$forecasts[[vri]], data = phrdw_forecasts$phrdw_list[[vri]], year = 2023)
}
```
