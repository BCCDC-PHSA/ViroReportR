...
raw_plover_data <- config$PLOVER$path
```

## Current season forecast

# Include current Rt value
...
forecast_flu_a_plover <- forecast_time_period(plover_flua, type = "flu_a", n_days = 14, start_date = "2022-09-18")

plot(forecast_flu_a_plover) +
  scale_x_date(limits = as.Date(c('2023-12-01','2024-01-15')))
...
```{r echo = FALSE}
# percentage, last should be out of 95
