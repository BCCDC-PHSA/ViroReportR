...
# ViroReportR <img src="man/figures/logo.png" align="right" height="139" alt="" />
...
```{r message = FALSE}
time_period_result_weekly <- forecast_time_period(
  data = weekly_data, 
start_date = "2022-10-02", n_days = 14, type = "flu_a", 
time_period = "weekly" , algorithm = "EpiEstim"
)
```
