...
For this short demonstration, we will use weekly data for Influenza A, which is provided with the `vriforecasting` package. The input dataset must have two columns: `date` and `confirm` in accordance to format accepted by the model fitting functions.
