...
#> # A tibble: 0 × 6
#> # Groups:   date [0]
#> # ℹ 6 variables: date <date>, coverage <chr>, Confirmed cases <dbl>,
#> #   Predicted cases <dbl>, 50 percentile interval bounds <glue>,
#> #   95 percentile interval bounds <glue>
#> 
#> $quantile_summary
#> # A tibble: 0 × 3
#> # ℹ 3 variables: coverage <fct>, counts <int>, proportion <lgl>
#> 
#> $time_weighted_mspe
#> [1] NaN
```
